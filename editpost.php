    ...
    <table class="table">
     ...
     <?php 
       ...
       echo '<td>'.$row['Blog_id'].'</td>
        <td><img src="image/'.$row['image'].'" class="img-responsive" alt="first image" style="border: 1px solid #000;padding:2px; width:150px; height:60px"></td>
        <td contenteditable="true"><input type="text" value="'.$row['title'].'"></td>
        <td contenteditable="true"> <input value="'.$row['author'].'" > </td>
        <td>'.$row['reg_date'].'</td>
        <td contenteditable="true"><div class="comment">'.$row['text'].'</div></td>
        
        <td><a href="?id='.$row['Blog_id'].'"><span class="table-remove glyphicon glyphicon-remove"></span></a>
        </td>
      </tr>'; 
}
       ?>
